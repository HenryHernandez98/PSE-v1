...
import techo.apps.isi.uca.com.android_aps.ui.adapters.ExperienceFromDatabaseAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    private void getFromDatabase(){
        ...
        RealmQuery<ExperienceModel> query =realm.where(ExperienceModel.class);

        RealmResults<ExperienceModel> results = query.findAll();
        mAdapter = new ExperienceFromDatabaseAdapter(results);
